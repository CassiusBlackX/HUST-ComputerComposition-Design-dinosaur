...
#
# Script generated by Vivado on Thu Dec 26 13:34:30 +0800 2024
...
#
# Usage        : bram_3.sh
#                bram_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_3.sh [-reset_run]
#                bram_3.sh [-reset_log]
#                bram_3.sh [-help]
#
...
# script info
echo -e "bram_3.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_3 xil_defaultlib.bram_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_3 -key {Behavioral:sim_1:Functional:bram_3} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="H:/application/vivado/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_3.sh [-help]\n\
Usage: bram_3.sh [-step]\n\
Usage: bram_3.sh [-lib_map_path]\n\
Usage: bram_3.sh [-reset_run]\n\
Usage: bram_3.sh [-reset_log]\n\
Usage: bram_3.sh [-keep_index]\n\
Usage: bram_3.sh [-noclean_files]\n\n\
