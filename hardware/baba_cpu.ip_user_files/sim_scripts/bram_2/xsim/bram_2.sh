...
#
# Script generated by Vivado on Thu Dec 26 13:34:27 +0800 2024
...
#
# Usage        : bram_2.sh
#                bram_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_2.sh [-reset_run]
#                bram_2.sh [-reset_log]
#                bram_2.sh [-help]
#
...
# script info
echo -e "bram_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_2 xil_defaultlib.bram_2 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_2.wdb xsim.dir libdpi.so)
...
Usage: bram_2.sh [-step]\n\
Usage: bram_2.sh [-lib_map_path]\n\
Usage: bram_2.sh [-reset_run]\n\
Usage: bram_2.sh [-reset_log]\n\
Usage: bram_2.sh [-keep_index]\n\
