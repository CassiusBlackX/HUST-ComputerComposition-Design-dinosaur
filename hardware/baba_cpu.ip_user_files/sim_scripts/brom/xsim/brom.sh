...
#
# Script generated by Vivado on Thu Dec 26 13:34:33 +0800 2024
...
#
# Usage        : brom.sh
#                brom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                brom.sh [-reset_run]
#                brom.sh [-reset_log]
#                brom.sh [-help]
#
...
# script info
echo -e "brom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./brom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot brom xil_defaultlib.brom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim brom -key {Behavioral:sim_1:Functional:brom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb brom.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./brom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: brom.sh [-help]\n\
Usage: brom.sh [-step]\n\
Usage: brom.sh [-lib_map_path]\n\
Usage: brom.sh [-reset_run]\n\
Usage: brom.sh [-reset_log]\n\
Usage: brom.sh [-keep_index]\n\
Usage: brom.sh [-noclean_files]\n\n\
