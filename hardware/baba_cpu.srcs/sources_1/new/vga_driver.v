module vga_driver (input wire clk,     // 65 MHz
  ...
  localparam [10:0] H_ACTIVE = 11'd639 ; //640个像素点的时间是在屏幕上确实有效的，也是h_counter的范围
  localparam [10:0] H_FRONT  = 11'd_15 ;//15 15个像素点的时间用来稳定下来，是显示屏需要的缓冲时间。
  localparam [10:0] H_PULSE  = 11'd_95 ;//95 也是显示屏在加载完一行之后需要的缓冲时间。
  ...
  assign next_x = (h_state == H_ACTIVE_STATE)?h_counter:11'd_0 ;//h_counter就已经是可显示的区域的坐标了。所以
